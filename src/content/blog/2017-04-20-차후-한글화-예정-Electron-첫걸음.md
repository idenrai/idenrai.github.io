---
title: "[차후 한글화 예정] Electron 첫걸음"
date: 2017-04-20
tags: ["Tech", "Electron", "electron"]
tistory_url: "https://idenrai.tistory.com/124"
---
...
-   **npm init**で**package.json**を作成
    ...
    -   もし**package.json**に**main scrip**tが設定されてない場合、
...
-   Atom ダウンロード ([https://atom.io](https://atom.io))
